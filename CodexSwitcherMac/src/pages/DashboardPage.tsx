      ...
      <div className="dashboard-workspace__hero">
        <AccountIdentityCard
          ...
          metrics={currentIsKey ? keyMetrics(activeIdentity) : [
            { label: "5h 已用", value: latestSnapshot ? `${latestSnapshot.window_5h_percent}%` : "--" },
            { label: "7d 已用", value: latestSnapshot ? `${latestSnapshot.window_7d_percent}%` : "--" },
        ...
        <AccountIdentityCard
          ...
          metrics={recommendedIsKey ? keyMetrics(recommendedIdentity) : [
            { label: "5h 已用", value: recommendedSwitchAccount ? `${recommendedSwitchAccount.latest_snapshot?.window_5h_percent ?? "--"}%` : "--" },
            { label: "7d 已用", value: recommendedSwitchAccount ? `${recommendedSwitchAccount.latest_snapshot?.window_7d_percent ?? "--"}%` : "--" },
